...
try:
        ...
        if choice == "Medical Assistant":
            ...
            if st.session_state.mabutton and medical_assistant_id and password:
                ...
                if data:
                    ...
                    logging.info(f"Medical Assistant Logged in at {datetime.now()} with ID {medical_assistant_id}")
                        ...
                        with st.spinner("Data is being Indexed..."):
                            ...
                            if index_status:
                                ...
                                if is_inserted == 1:
                                    ...
                                    logging.info(f"Data Indexed Successfully for {st.session_state.pid}")
                else:
            ...
            if patient_id:
                ...
                if new_data:
                    ...
                    logging.info(f"Patient logged in at {datetime.now()} with ID {patient_id}")
                else:
                    st.session_state.user_verified = False
            ...
            if dpatient_id:
                ...
                if new_data:
                    ...
                    logging.info(f"Doctor logged in at {datetime.now()} with ID {dpatient_id}")
                else:
                    st.session_state.user_verified = False
    ...
    with footer_container:
        ...
        st.markdown(
            '<div class="footer">Concept By <a class="anchorLink" href="https://thoughtgreen.com/" '
            'target="_blank"><img class="image" height="32px" width="32px " '
            'src="https://dul6omc8ld2wp.cloudfront.net/event_banners/tgt_logo_New_11zon.png" alt="logo" '
            '/>Thoughtgreen Technologies</a></div>',
            unsafe_allow_html=True)
